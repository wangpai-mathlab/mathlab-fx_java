...
public class BinaryEncoding {
     ...
     * @since 2022-12-3
     */
    public static long encodeWithNoCheckForCom(final int n, int[] ascendCom, int offset) {
        throw new DevelopingException("此方法还未完成编写，无法使用"); // FIXME：2022年12月3日：此方法待完成
    }
}
