package org.wangpai.mathlab.advanced.numeric.basic.operator;
...
import org.wangpai.mathlab.exception.unchecked.MathlabUncheckedException;
...
public class Operator implements Serializable {
    ...
    public Operator(Symbol operator) {
        ...
        if (operator.isDigit()) {
            throw new LogicalException("异常：误将操作数当成操作符");
        }
    ...
    public boolean equals(Symbol other) {
        ...
        } catch (MathlabUncheckedException exception) {
